...
namespace WebMonitoring.TagHelpers
{
    ...
    public class BreakTimeTagHelperComponent : TagHelper
    {
        private List<BreakTime> BreakTimes { get; set; } = new List<BreakTime>()
        {
            ...
            new BreakTime(LineDescription.LineWS3Hr12CC_Welding, 1, 9, 30, 11, 40),
            new BreakTime(LineDescription.LineWS3Hr12CC_Welding, 2, 17, 30, 19, 40),
            new BreakTime(LineDescription.LineWS3Hr12CC_Welding, 3, 1, 30, 3, 30),
